...
export default function About() {
  return (
    <div>
        ...
        <div className="md:my-10 max-md:my-3 max-w-7xl mx-auto md:p-10 max-md:p-5">
            <h1 className="font-bold md:text-2xl max-md:text-sm my-3">Founder - Shri Chandra Shekhar Mishra</h1>
            <p className='text-sm font-normal'>Freedom Fighter | March 21 , 1921 - June 13 , 2010</p>

            <div className="content md:my-10 max-md:my-4">
